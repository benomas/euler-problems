...
const PrimesTool = function () {
  ...
  this.firstNPrimeNumbers = function (n) {
    let i = this.firstPrimeNumber() + 1

    while(this.primeNumbersArray().length < n){
      if(this.primeNumbersArray().find(primeNumber=>i % primeNumber === 0) === undefined){
        this.primeNumberCollect(i)

        console.log(this.primeNumbersArray().length)
      }
      i++
    }
...
primesTool.firstNPrimeNumbers(10001)

console.log(primesTool.lastPrimeNumber())
